  ...
  return (
    <section className="blog-list section-padding bg-gray text-dark">
      <div className="container">
        <div className="sec-head mb-80">
          <div className="d-flex align-items-center justify-end">
            <div>
              ...
              <h3 className="text-u f-bold fz-50">
                Blog & <span className="f-ultra-light">Insights</span>
              </h3>
            </div>
            <div className="ml-auto underline">
              <a
                href="/blog"
                className="animsition-link all-more sub-title ls1"
              >
                <span>
                  View All Posts{" "}
                  <svg
        ...
        {data.map((item, index) => (
          <div
            className="item block wow fadeInUp"
          ...
          >
            <a
              href={item.link}
              className="block__link animsition-link"
              data-img={item.img}
            ></a>
            <div className="row">
              ...
              <div className="col-lg-3 offset-lg-3 d-flex align-items-center justify-end">
                <div className="ml-auto">
                  <a
                    ...
                    className="more mt-15 animsition-link"
                  >
                    <span>
                      Continue Read{" "}
                      <svg
