      ...
      <div className="container section-padding">
        ...
        <div className="serv-inline mt-80">
          <div className="row justify-content-end">
            <div className="col-lg-8">
              <div
                className="item pb-30 pt-30 mb-30 bord-thin-top bord-thin-bottom wow fadeInUp"
                data-wow-delay=".2s"
              >
                <div className="d-flex align-items-center">
                  <div>
                    <span className="mb-10 opacity-8">
                      01 / <span className="text-u ml-5">Branding</span>
                    </span>
              ...
              <div
                className="item pb-30 mb-30 bord-thin-bottom wow fadeInUp"
                data-wow-delay=".4s"
              >
                <div className="d-flex align-items-center">
                  <div>
                    <span className="mb-10 opacity-8">
                      02 / <span className="text-u ml-5">Branding</span>
                    </span>
              ...
              <div
                className="item pb-30 bord-thin-bottom wow fadeInUp"
                data-wow-delay=".6s"
              >
                <div className="d-flex align-items-center">
                  <div>
                    <span className="mb-10 opacity-8">
                      03 / <span className="text-u ml-5">Design</span>
                    </span>
