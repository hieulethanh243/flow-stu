      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-11">
            ...
            <h3 className="text-u text-indent ls1">
              We create unexpected connections between creative people with a
              passion, and creative businesses on a mission, so they can make
